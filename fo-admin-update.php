    ...
    <div class="container">
        ...
        <form action="" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" id="nom" placeholder="Dujardin">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" id="mobile" placeholder="03 90 98 78 54">
                </div>
            </div>
            <div class="form-group row">
                <label for="email" class="col-sm-2 col-form-label">Email</label>
                <div class="col-sm-8">
                  <input type="text" class="form-control bg-light" id="email" placeholder="jdujardin@email.com" >
                </div>
            </div>
            <div class="form-group row" id="role">
                ...
                <div class="col-sm-8">
                    <select id="role" class="form-control  bg-light" >
                        <option selected>Observateur</option>
                        <!-- <option disabled>Utilisateur</option> -->
